...
public class Category implements AppenderAttachable {
  ...
  */
  ...
  void error(Object message, Throwable t) {
    ...
    /**
     Log a message object with the {@link Level#BUSINESS BUSINESS} Level.
     @param message the message object to log */
    public
    void business(Object message) {
        if(repository.isDisabled(Level.BUSINESS_INT))
            return;
        if(Level.BUSINESS.isGreaterOrEqual(this.getEffectiveLevel()))
            forcedLog(FQCN, Level.BUSINESS, message, null);
    }
    ...
    /**
     ...
     @param message the message object to log */
    public
    void business(String logType, String message) {
        if(repository.isDisabled(Level.BUSINESS_INT))
            return;
        if(Level.BUSINESS.isGreaterOrEqual(this.getEffectiveLevel()))
            forcedLog(FQCN, Level.BUSINESS, logType, message, null);
    }
    ...
    public
    void business(String logType, String key, String value) {
    ...
    /**
     Log a message object with the <code>BUSINESS</code> level including
     the stack trace of the {@link Throwable} <code>t</code> passed as
     parameter.  */
    public
    void business(Object message, Throwable t) {
        if(repository.isDisabled(Level.BUSINESS_INT))
            return;
        if(Level.BUSINESS.isGreaterOrEqual(this.getEffectiveLevel()))
            forcedLog(FQCN, Level.BUSINESS, message, t);

    }

    /**
     Log a message object with the {@link Level#HEARTBEAT HEARTBEAT} Level.
     @param message the message object to log */
    public
    void heartbeat(Object message) {
        if(repository.isDisabled(Level.HEARTBEAT_INT))
            return;
        if(Level.HEARTBEAT.isGreaterOrEqual(this.getEffectiveLevel()))
            forcedLog(FQCN, Level.HEARTBEAT, message, null);
    }

    /**
     Log a message object with the <code>HEARTBEAT</code> level including
     the stack trace of the {@link Throwable} <code>t</code> passed as
     parameter.  */
    public
    void heartbeat(Object message, Throwable t) {
        if(repository.isDisabled(Level.HEARTBEAT_INT))
            return;
        if(Level.HEARTBEAT.isGreaterOrEqual(this.getEffectiveLevel()))
            forcedLog(FQCN, Level.HEARTBEAT, message, t);
  ...
  void forcedLog(String fqcn, Priority level, Object message, Throwable t) {
    ...
    /**
     ...
     without further checks.  */
    protected
    void forcedLog(String fqcn, Priority level, String logType, Object message, Throwable t) {
        callAppenders(new LoggingEvent(fqcn, this, level, logType, message, t));
    }
