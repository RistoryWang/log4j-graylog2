...
public class Level extends Priority implements Serializable {
  ...
  /**
   The <code>BUSINESS</code> level designates business events.  */
  final static public Level BUSINESS = new Level(BUSINESS_INT, "BUSINESS", 999);

  /**
   The <code>BUSINESS</code> level designates business events.  */
  final static public Level HEARTBEAT = new Level(HEARTBEAT_INT, "HEARTBEAT", 998);
  ...
  */
  ...
  Level toLevel(int val, Level defaultLevel) {
    ...
    case BUSINESS_INT: return Level.BUSINESS;
  ...
  */
  ...
  Level toLevel(String sArg, Level defaultLevel) {                  
    ...
    if(s.equals("BUSINESS")) return Level.BUSINESS;
